    ...
    <div class="app-container">
      ...
      <div class="sidebar">
        ...
        <nav style="flex:1">
          ...
          <button class="nav-item ${state.currentView === 'rules'       ? 'active' : ''}" onclick="changeView('rules')      "><span class="nav-icon">${NAV_ICONS.riskcalc}</span>Rules</button>
      ...
      ${state.showQuickAdd    ? quickAddModal() : ''}
    </div>
  `;
}
